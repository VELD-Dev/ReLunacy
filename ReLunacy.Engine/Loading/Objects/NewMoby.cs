...
public record struct NewMoby : IMoby
{
    ...
    [FileOffset(0x00)] public Vector4 boundingSphere; // Relative
    ...
    public readonly uint BangleCount => bangleCount1;

    public MobyBangle[] bangles { readonly get => newMobyBangles; set => newMobyBangles = value; }

    public static NewMoby Read(StreamHelper sh) => FileUtils.ReadStructure<NewMoby>(sh);
