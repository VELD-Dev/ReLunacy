...
/// <summary>
/// Represents a UFrag (Uniform Fragment) - terrain geometry baked directly into zones
/// NOT instanced - direct geometry data in level zones
/// Used primarily for terrain and large static geometry
/// </summary>
public interface IUFrag : IAsset
{
    ...
    /// <summary>
    /// Gets tangents for normal mapping
    /// </summary>
    float[]? GetTangents();
    ...
    /// <summary>
    /// Whether this is from the old or new engine
    /// </summary>
