...
public class ImGuiController : IDisposable
{
    ...
    private Vec2 _scaleFactor = Vec2.One;
    ...
    public ImGuiController(int width, int height)
    {
        ...
        // New method for backend flags in 1.91
    ...
    public void CreateDeviceResources()
    {
        ...
        // Shader sources remain largely the same
...
void main()
{
    ...
    public void RecreateFontDeviceTexture()
    {
        ...
        // Updated for ImGui.NET 1.91
        io.Fonts.GetTexDataAsRGBA32(out IntPtr pixels, out int width, out int height, out int bytesPerPixel);

        Console.WriteLine($"Font Texture: Width={width}, Height={height}, BytesPerPixel={bytesPerPixel}");
        Console.WriteLine($"Pixels Pointer: {pixels}");
        ...
        // Updated method for setting font texture ID in 1.91
    ...
    private void UpdateImGuiInput(GameWindow wnd)
    {
        ...
        // Updated input handling for 1.91
        ...
        var screenPoint = new Vec2(mouseState.X, mouseState.Y);
        io.AddMousePosEvent(screenPoint.X, screenPoint.Y);

        // Key input changes in 1.91
    ...
    // New method to convert Keys to ImGuiKey
    private ImGuiKey ConvertKeyToImGuiKey(Keys key)
    {
        return key switch
        {
    ...
    public void MouseScroll(Vec2 offset)
    {
        ImGuiIOPtr io = ImGui.GetIO();
        // Updated method for mouse wheel in 1.91
    ...
    private void RenderImDrawData(ImDrawDataPtr draw_data)
    {
        ...
        {
            Console.WriteLine($"Error in RenderImDrawData: {ex.Message}");
            Console.WriteLine(ex.StackTrace);
        }
        finally
        {
            // Ensure ImGui state is reset
            ImGui.EndFrame();
        }
    }
